...
/**
 * Defines backup_attendance_activity_task class
 *
...
/**
 * Provides the steps to perform one complete backup of the attendance instance
 *
 * @package   mod_attendance
 * @category  backup
 * @copyright 2015 Your Name <your@email.adress>
...
class backup_attendance_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the attendance.xml file
     */
    ...
    static public function encode_content_links($content) {
        ...
        $search = '/('.$base.'\/mod\/attendance\/index.php\?id\=)([0-9]+)/';
        $content = preg_replace($search, '$@attendanceINDEX*$2@$', $content);
